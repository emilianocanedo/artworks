...
void draw() {
  ...
  {
      // 1
      circle(206 + 150 * cos((s-f*97.7)/4*0.0015), 206 + 100 * sin((s-f*220)/3*0.0015), 5 );
      // 2
      //circle(599 + 150 * sin((s+f*250)*0.0011), 206 - 100 * cos((s+f*250)*coef), 4);
      //circle(599 + 150 * sin((s+f*250)*0.0011), 206 - 100 * cos((s+f*5)*coef), 4);
      circle(599 + 150 * sin((s+f*250)*0.0011), 206 - 100 * cos((s+f*200)*coef), 5);
      // 3
      //circle(206 + 150 * sin((s+f*250)*0.0011), 599 - 100 * cos((s+f*250)*coef), 4);
      //circle(206 + 150 * sin((s+f*5)*0.0011), 599 - 100 * cos((s+f*250)*coef), 4);
      circle(206 + 150 * sin((s+f*200)*0.0011), 599 - 100 * cos((s+f*250)*coef), 5);
      // 4
      circle(599 + 150 * cos((s-f*220)/4*0.0015), 599 + 100 * sin((s-f*220)/3*0.0015), 5);
  }
}
